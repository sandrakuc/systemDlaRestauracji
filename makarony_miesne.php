...
$sqll="select * from potrawy where kategoria='Dania miesne' and podkategoria='makarony_miesne'";
...
mysqli_close($link);
?>
<a href="miesne.php"><button value="Wstecz" id="szukajka">Wstecz</button></a>
</center>
</div>
</body>
</html>
