...
$sqll="select * from potrawy where kategoria='Napoje zimne' and podkategoria='napoje_niegazowane'";
...
mysqli_close($link);
?>
<a href="zimne.php"><button value="Wstecz" id="szukajka">Wstecz</button></a>
</center>
</div>
</body>
</html>
