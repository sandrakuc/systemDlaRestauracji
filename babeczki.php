...
$sqll="select * from potrawy where kategoria='Desery' and podkategoria='babeczki'";
...
while($r = mysqli_fetch_array($zaw1)){
	...
	echo "</select><br>
	<input type='submit' name='dodaj' value='Dodaj potrawe' id='szukajka'>
	</form>
	</div></div>";
;}
;
mysqli_close($link);
?>
<a href="desery.php"><button value="Wstecz" id="szukajka">Wstecz</button></a>
</center>
</div>
</body>
</html>
