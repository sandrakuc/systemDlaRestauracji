...
$sqll="select * from potrawy where kategoria='Dania jarskie' and podkategoria='nalesniki_jarskie'";
...
mysqli_close($link);
?>
<a href="jarskie.php"><button value="Wstecz" id="szukajka">Wstecz</button></a>
</center>
</div>
</body>
</html>
